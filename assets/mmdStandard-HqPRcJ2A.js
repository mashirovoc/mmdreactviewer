import{M as r,S as l,s as d,a as t}from"./index-CjA6CRfh.js";function n(i){return i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}class a extends r{isCompatible(f){switch(f){case l.GLSL:return!0;default:return!1}}getCustomCode(f){if(f==="vertex"){const e={};return e.CUSTOM_VERTEX_DEFINITIONS=d,e[`!${n("finalWorld=finalWorld*influence;")}`]=`
${t}
