import{M as i,S as l,b as s,c as a}from"./index-BoVMapfc.js";function f(o){return o.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}class d extends i{isCompatible(n){switch(n){case l.WGSL:return!0;default:return!1}}getCustomCode(n){if(n==="vertex"){const e={};return e.CUSTOM_VERTEX_DEFINITIONS=s,e[`!${f("finalWorld=finalWorld*influence;")}`]=`
${a}
